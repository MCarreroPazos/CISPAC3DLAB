# CISPAC 3D LAB - Sitio Web Oficial
...
Esta nueva unidad, innovadora y multidisciplinar, dota al CISPAC de tecnología avanzada para abordar retos complejos en las áreas de la Arqueología, Geografía, Geología, Historia, Economía rural y Agroecología, respondiendo a las necesidades de la investigación actual.

### 🔬 Equipamiento Disponible

- **Escáner 3D de largo alcance** (Leica 360 RTC LT)
- **Escáner 3D de corto alcance** (HandySCan 3D pro series)
- **Georradar DS 2000** (Leica GeoSystems)
- **Dron LiDAR** (DJI Matrice 300 RTK)
- **Impresora 3D** (Creality 3D )
- **Workstation de procesamiento** de alto rendimiento
...
**Teléfono:** [+34] 881971010  
**Email:** cispac3dlab@usc.gal  
...
El template original de esta página web fue diseñado a partir de:  
https://photonlines.github.io/Research-Lab-Website/

**Personalización y desarrollo:** CISPAC 3D LAB, miguel carrero 
...
- [Web del CISPAC](https://cispac.gal/es/)
- [Universidad de Santiago de Compostela](https://www.usc.gal/)

---

**© 2026 CISPAC 3D LAB - Todos los derechos reservados**
